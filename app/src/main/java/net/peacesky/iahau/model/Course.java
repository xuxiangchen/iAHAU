...
public class Course extends DataSupport {
    ...
    private int startYear = 2015;//学年开始年
    private int endYear = 2016;//学年结束年
    private int semester = 1;//学期
    ...
    public String toString() {
        return "Course [id=" + id + ", startYear=" + startYear + ", studentID=" + studentID + ", endYear="
